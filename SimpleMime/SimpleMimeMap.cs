namespace SimpleMime
{
    public static class SimpleMimeMap
    {
        ...
        /// Some file extensions have multiple destination mime types (e.g. "asc")
        /// </summary>
        public static readonly Dictionary<string, List<string>> MimeTypesByExtension = new()
        {
            // Do not modify text between map start and map end, it will be replaced programmatically
            // [MAP START]
            ...
            { "sql", ["application/sql", "application/x-sql"] },
            ...
            { "rar", ["application/vnd.rar", "application/x-compressed", "application/x-rar-compressed"] },
            ...
            { "prc", ["application/x-mobipocket-ebook", "application/x-pilot", "model/prc"] },
            ...
            { "exe", ["application/x-msdos-program", "application/x-msdownload"] },
            ...
            { "xlf", ["application/x-xliff+xml", "application/xliff+xml"] },
        ...
        private static string? GetExt(string filename)
        {
            ...
            return dotIdx == -1 ? filename : filename[(dotIdx + 1)..];
        }
        ...
        public static List<string> GetMimeTypes(string filename)
        {
            var ext = GetExt(filename);
            if (ext == null) return [defaultMimeType];
            return MimeTypesByExtension.TryGetValue(ext, out var mimeTypes) ? mimeTypes : [defaultMimeType];
        }
        ...
        {
            return MimeTypesByExtension.FirstOrDefault(x => x.Value.Contains(mimeType)).Key ?? "";
        }
        ...
        {
            return MimeTypesByExtension.Where(x => x.Value.Contains(mimetype)).Select(x => x.Key).ToList();
        }
        ...
        public static List<string> GetExtensionsForMimeTypePrefix(string mimeTypePrefix)
        {
            return MimeTypesByExtension
                .Where(x => x.Value.Any(v => v.StartsWith(mimeTypePrefix)))
                .Select(x => x.Key)
                .ToList();
        }
        ...
        {
            return GetExtensionsForMimeTypePrefix("image/");
        }
        ...
        {
            return GetExtensionsForMimeTypePrefix("video/");
        }
    }
}
